...
const DocumentListPage = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(#e5e7eb-1px, transparent_1px)] bg-size-[16px_16px] opacity-30 pointer-events-none" />
          ...
          <form onSubmit={handleUpload} className="space-y-5">
            ...
            <div className="flex gap-3 pt-2">
              ...
              <button
                type="submit"
                disabled={uploading}
                className="flex-1 h-11 bg-linear-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white text-sm font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-emerald-500/25 disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98]"
              >
                {uploading ? (
