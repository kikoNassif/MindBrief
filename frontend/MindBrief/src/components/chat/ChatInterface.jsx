  ...
  const handleSendMessage = async (e) => {
    ...
    try {
      ...
      const assistantMessage = {
        ...
        timestamp: new Date(),
        relevantChunks: response.data.releventChunks
      };
      ...
      <div className="flex-1 p-6 overflow-y-auto bg-linear-to-br from-slate-50/50 via-white/50 to-slate-50/50">
        ...
        {loading && (
          <div className="flex items-center gap-3 my-4">
            ...
            <div className="flex items-center gap-3 px-4 py-3 rounded-2xl rounded-bl-md bg-white border border-slate-200/60">
