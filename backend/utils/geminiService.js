 ...
 * @param {string} text- Document texts
...
export const explainConcept = async (concept, context) => {
  const prompt = `Explain the concept of "${concept}" based on the following context. Provide a clean, educational explanation that's easy to understand. Include examples if relevant.
